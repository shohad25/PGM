...
data_train = pickle.load(open("/home/ohadsh/work/python/courses/PGM/data/data_train.pickle"))
C = 0.01
...
data_val = pickle.load(open("/home/ohadsh/work/python/courses/PGM/data/data_val.pickle"))
