...
train_name = 'train_pred_-5.pkl'
test_name = 'test_pred_-5.pkl'
...
nn_predictions_train = arrange_letters_in_pred_like(X_train, train_net_pred, size_of_pred=256)
nn_predictions_test = arrange_letters_in_pred_like(X_test, test_net_pred, size_of_pred=256)
...
w = chain_ssvm_nn.w[26 * 256:].reshape(26, 26)
