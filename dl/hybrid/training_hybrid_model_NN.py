...
training_data_dir = os.path.join(basic_dir, "data/nets_with_ftrs.pkl")
f = open(training_data_dir, 'r+')
training_data_all = cPickle.load(f)
f.close()

test_data_dir = os.path.join(basic_dir, "data/nets_with_ftrs_test.pkl")
...
for length in training_lengths:
    ...
    # save results:
    base_path = "/home/ohadsh/Dropbox/Rami/Code_ohad/outputs/NN_hybrid"
